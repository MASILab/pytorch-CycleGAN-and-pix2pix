...
#             print('j:%d' % j)
            ...
            tmp_file_name = '%s/patch/%s/%s_99AF_DAPI_MUC2_IN_IHE_ROI_crop256_%s_%s.png' % (src_dir,sample_id,sample_id,i,j) 
            print(tmp_file_name)
            imgs_comb = Image.fromarray( imgs_comb)
            imgs_comb.save( tmp_file_name, 'PNG')           
            
marker_list = ['AF_GFP_100ms_ROUND_01_99Percentile'] 
marker_list2 = ['AF_GFP_100ms_ROUND_01_99Percentile','DAPI','MUC2']
