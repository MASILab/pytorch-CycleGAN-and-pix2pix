...
#             print('j:%d' % j)
            ...
            tmp_file_name = '%s/patch/%s/%s_AF_IN_IHE_ROI_crop256_%s_%s.png' % (src_dir,sample_id,sample_id,i,j) 
            print(tmp_file_name)
            imgs_comb = Image.fromarray( imgs_comb)
            imgs_comb.save( tmp_file_name, 'PNG')           
            
marker_list = ['AF_GFP_100ms_ROUND_01','DAPI_UV_12ms_ROUND_00','DAPI','MUC2'] # only contains AF,'ACTININ','BCATENIN','CD11B','CD20','CD3D','CD45','CD4','CD68','CD8','CGA','COLLAGEN','DAPI','ERBB2','FOXP3','HLAA','LYSOZYME','MUC2','NAKATPASE','OLFM4','PANCK','PCNA','PEGFR','PSTAT3','SMA','SOX9','VIMENTIN']
